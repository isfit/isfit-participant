...
ActiveRecord::Schema.define(:version => 20150106201251) do
  ...
  create_table "participants", :force => true do |t|
    ...
    t.integer  "departure_trd",                                      :default => -1
    t.integer  "departure_norway",                                   :default => -1
    t.string   "osl_departure_date"
    t.string   "osl_departure_flight_number"
    t.string   "trd_departure_date"
    t.string   "trd_departure_flight_number"
    t.text     "other_trondheim_departure_information"
