class Ability
  ...
  def initialize(user)
    ...
    if user.has_role? :functionary
      ...
      can [:read, :update, :travel_support, :invitation, :isfit_transportation, :validate_deadline, :check_deadline, :approve_deadline, :failed_deadline, :remove_deadline, :ignore, :unignore], Participant
