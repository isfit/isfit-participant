...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      #------------------------------------------------------------------------------------------------------------------------------------------#
      [    :calendar_tab                  ,    'Calendar'                  ,    calendar_path                  ,    true        ,    true        ],
      [    :information_categories_tab    ,    'Information Categories'    ,    information_categories_path    ,    true        ,    true        ],
      ...
      [    :search_tab                    ,    'Search'                    ,    search_index_path              ,    true        ,    true        ],
      ...
      [    :answers_tab                   ,    'Answers'                   ,    question_answers_path          ,    true        ,    true        ],
  ...
  config.actions do
    [
      ...
      [    :functionaries             ,    :all_actions    ,    :functionaries_tab             ],
